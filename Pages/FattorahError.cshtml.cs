...
namespace Nursery.Pages
{
    public class FattorahErrorModel : PageModel
    {
        ...
        private readonly ILogger<FattorahErrorModel> _logger;
        public FattorahErrorModel(ILogger<FattorahErrorModel> logger,NurseryContext context, IEmailSender emailSender, UserManager<ApplicationUser> userManager, IHostingEnvironment env, IConfiguration configuration)
        {
            _context = context;
        ...
        //    var responseMessage = client.PostAsync(baseURL, httpContent);
        //    var res = await responseMessage.Result.Content.ReadAsStringAsync();
        //    var FattoraResStatus = JsonConvert.DeserializeObject<FattorhResult>(res);
        ...
        //        int NurseryId = 0;
        //        bool checkRes = int.TryParse(fattorahPaymentResult.UserDefinedField, out NurseryId);
        ...
        //                    if (checkRes)
        //                    {
        //                        NurseryMember = _context.NurseryMember.FirstOrDefault(e => e.NurseryMemberId == NurseryId);
