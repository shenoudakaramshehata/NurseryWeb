...
{
    public class RegistrationNModel : PageModel
    {
        ...
        public RegistrationNModel(NurseryContext context,
        ...
        public IActionResult OnGetFillCityList( string Values)
        {
            ...
            var lookup = from i in _context.City
                         orderby i.CityId
                         where i.CountryId== int.Parse(Values)
                         select new
                         {
                             Value = i.CityId,
                             Text = i.CityTlEn
        ...
        public IActionResult OnGetFillAreaList(string Values)
        {
            var lookup = from i in _context.Area
                           orderby i.AreaId
                           where i.CityId == int.Parse(Values)
