...
namespace Nursery.Pages
{
    public class FattorahSuccessModel : PageModel
    {
        ...
        public FattorahSuccessModel(ILogger<FattorahSuccessModel> logger,NurseryContext context, IEmailSender emailSender, UserManager<ApplicationUser> userManager,IHostingEnvironment env, IConfiguration configuration)
        {
            _context = context;
